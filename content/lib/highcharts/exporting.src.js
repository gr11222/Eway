...
extend(Chart.prototype, {
	...
	printChart: function () {
        ...
        var htmlhead = "<html><head><title>图形</title><body>";
        var htmltail = "</body></head></html>";
        var docStr = $('#showColumn').html();
        newWindow.document.write(htmlhead+docStr+htmltail);
	...
	printTable: function () {
	    var newWindow=window.open("","_blank");//打印窗口要换成页面的url
        var htmlhead = "<html><head><title>表格</title><body>";
        var htmltail = "</body></head></html>";
        var docStr = $('#tableDiv').html();
        newWindow.document.write(htmlhead+docStr+htmltail);
        newWindow.document.close();
        newWindow.print();
        newWindow.close();
	...
	// 同时打印
	printChartTable: function () {
	    var newWindow=window.open("","_blank");//打印窗口要换成页面的url
        var htmlhead = "<html><head><title>图形+表格</title><body>";
        var htmltail = "</body></head></html>";
        var docStrChart = $('#chartDiv').html();
        var docStrTable = $('#tableDiv').html();
        newWindow.document.write(htmlhead+docStrChart+docStrTable+htmltail);
        newWindow.document.close();
        newWindow.print();
        newWindow.close();
	},
