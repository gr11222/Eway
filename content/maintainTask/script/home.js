...
function funGetInfo() {
	...
	$.ajax({
		type: "post",
		dataType: 'json',
		url: "/DevOpsNoSpring/servlet/DevOpsService?cmd=DevOpsMaintainTaskSearchCmd",
		contentType: "application/text,charset=utf-8",
		data: funGetInfoPara(),
		success: function(msg) {
			loadingStop();
...
function createInfos(msg) {
	...
	for (var i = 0; i < realData.length; i++) {
		...
		str += "<td class='text-center taskNode'  style='word-wrap: break-word;word-break: break-all;' title='" + realData[i]["routeName"] + "'><a class='roleClick' href='javascript:void(0)'  data='" + JSON.stringify(realData[i]["routeItems"]) + "'>" + realData[i]["routeName"] + "</a></td>";
		if (realData[i]["userItems"]) {
			var participantName = [];
			for (var j = 0; j < realData[i]["userItems"].length; j++) {
				participantName.push(realData[i]["userItems"][j].userName);
			}
		...
		$(".edit-class").click(function(e) {
			...
			// cycleArr = [];
			for (var i = 0; i < theData["userItems"].length; i++) {
				taskMan.push(theData["userItems"][i]["userId"]);
			}
...
function funDeleteMeetingInfo(id) {
	$.ajax({
		type: "post",
		dataType: 'json',
		url: "/DevOpsNoSpring/servlet/DevOpsService?cmd=DevOpsMaintainTaskDeleteCmd",
		contentType: "application/text,charset=utf-8",
...
function editInfo() {
	$.ajax({
		type: "post",
		dataType: 'json',
		url: "/DevOpsNoSpring/servlet/DevOpsService?cmd=DevOpsMaintainTaskUpdateCmd",
		contentType: "application/text,charset=utf-8",
		data: editInfoPara(),
		success: function(msg) {
...
function addInfo() {
	$.ajax({
		type: "post",
		dataType: 'json',
		url: "/DevOpsNoSpring/servlet/DevOpsService?cmd=DevOpsMaintainTaskAddCmd",
		contentType: "application/text,charset=utf-8",
		data: addInfoPara(),
		success: function(msg) {
...
function editParaAjax(id) {
	$.ajax({
		type: "post",
		dataType: 'json',
		url: "/DevOpsNoSpring/servlet/DevOpsService?cmd=DevOpsMaintainTaskPortionSearchCmd",
		contentType: "application/text,charset=utf-8",
		data: editPara(id),
		success: function(msg) {
